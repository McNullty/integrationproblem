...
public class PrintTwiceMessageProcessorImpl implements MessageProcessor {
    ...
    private static final Logger log = LoggerFactory.getLogger(PrintTwiceMessageProcessorImpl.class);
    ...
    public void process(final String queueName) {
        ...
        while (true) {
            ...
            if (message != null) {
                PrintTwiceMessageProcessorImpl.log.debug("Got message: {}", message);
